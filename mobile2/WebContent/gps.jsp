...
<% 
	String url = "jdbc:mysql://lora.cfotzkdyermm.ap-northeast-2.rds.amazonaws.com:3306/lora?useSSL=false&serverTimezone=UTC";
	...
	try
	{
		...
		conn = DriverManager.getConnection(url,"lora","12345678");
